...
public class CashFlowSi extends OpasOrganizationObject implements Serializable{
	...
	private String paymentDetailsLine1; /*GGTRD1*/
	@Column(name = "PAYMENT_DETAILS_LINE_2", length = 35)
	private String paymentDetailsLine2; /*GGTRD2*/
	@Column(name = "PAYMENT_DETAILS_LINE_3", length = 35)
	private String paymentDetailsLine3; /*GGTRD3*/
	@Column(name = "PAYMENT_DETAILS_LINE_4", length = 35)
	private String paymentDetailsLine4; /*GGTRD4*/
	...
	private boolean globalStandardCompliantFlag;
	private PayWireType payWireType;
	...
	private ChargesForIndicator chargesForIndicator; /*GGTRCF*/
	...
	*/
	...
	public String getPaymentDetailsLine3() {
		return paymentDetailsLine3;
	}
	public void setPaymentDetailsLine3(String paymentDetailsLine3) {
		this.paymentDetailsLine3 = paymentDetailsLine3;
	}
	public String getPaymentDetailsLine4() {
		return paymentDetailsLine4;
	}
	public void setPaymentDetailsLine4(String paymentDetailsLine4) {
	...
	public boolean isGlobalStandardCompliantFlag() {
		return globalStandardCompliantFlag;
	}
	public void setGlobalStandardCompliantFlag(boolean globalStandardCompliantFlag) {
		this.globalStandardCompliantFlag = globalStandardCompliantFlag;
	}
	public PayWireType getPayWireType() {
		return payWireType;
	}
	public void setPayWireType(PayWireType payWireType) {
		this.payWireType = payWireType;
	}
	...
	public ChargesForIndicator getChargesForIndicator() {
		return chargesForIndicator;
	}
	public void setChargesForIndicator(ChargesForIndicator chargesForIndicator) {
		this.chargesForIndicator = chargesForIndicator;
	}
