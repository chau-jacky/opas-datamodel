...
public class Counterparty extends Party implements Serializable {
	...
	private ERDSLegalEntity erdsLegalEntity;
	...
	public ERDSLegalEntity getErdsLegalEntity() {
		return erdsLegalEntity;
	}

	public void setErdsLegalEntity(ERDSLegalEntity erdsLegalEntity) {
		this.erdsLegalEntity = erdsLegalEntity;
	}
