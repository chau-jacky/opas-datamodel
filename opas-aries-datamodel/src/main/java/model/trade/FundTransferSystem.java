...
public class FundTransferSystem extends OpasOrganizationObject {
	...
	public FundTransferSystem(String ftsCode) {
		...
		ftsToClearingSystemCodeMap.put(FtsCode.CASH, NationalClearingSystemCode.XX);
		...
		ftsToClearingSystemCodeMap.put(FtsCode.DDA, NationalClearingSystemCode.DD);
		...
		ftsToClearingSystemCodeMap.put(FtsCode.INT, NationalClearingSystemCode.XX);
		...
		ftsToClearingSystemCodeMap.put(FtsCode.SUC, NationalClearingSystemCode.SU);
