...
public class Organization extends OpasObject implements Serializable {
	...
	private String branchMneumonic;
	...
	private boolean EURegulationFlag;
	...
	public String getBranchMneumonic() {
		return branchMneumonic;
	}

	public void setBranchMneumonic(String branchMneumonic) {
		this.branchMneumonic = branchMneumonic;
	}
	...
	public boolean isEURegulationFlag() {
		return EURegulationFlag;
	}

	public void setEURegulationFlag(boolean eURegulationFlag) {
		EURegulationFlag = eURegulationFlag;
	}
